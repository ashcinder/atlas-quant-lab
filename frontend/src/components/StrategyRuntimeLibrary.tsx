...
export default function StrategyRuntimeLibrary() {
  ...
  return <section className="runtime-library">
    <header><div><em>EXECUTABLE LIBRARY</em><h2>策略从这里进入真实运行链路</h2><p>发布版本一经创建不可修改；支持免费或 BKC 订阅，授权锁定到具体版本。</p></div><button disabled={busy} onClick={() => void act(load)}><RefreshCw size={15} />刷新</button></header>
    ...
    <PrivateStrategyRegistration onCreated={load} />
